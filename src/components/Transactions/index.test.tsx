...
const ITEMS_MOCK = [
  {
    ...
    nonce: '603',
    blockHash:
      '0xa7459683dd9e7bb019c11c3b8b88b78a27d2bc4456fb2066f1640c1d560b3137',
    transactionIndex: '1',
  ...
  },
  {
    ...
    nonce: '602',
    blockHash:
      '0xd41e55f1f14595795018e4db5f53771aaaf126c61aac55799e9607c5e907906e',
    transactionIndex: '2',
    from: '0xfffa5813ed9a5db4880d7303db7d0cbe41bc771f',
    to: '0x83ec7b0506556a7749306d69681adbdbd08f0769',
    value: '2',
  ...
  },
  {
    ...
    nonce: '601',
    blockHash:
      '0x0674300b151cca798f74480514ade8c0a633a0fde9ce2e127e60a6607e5a19c5',
    transactionIndex: '2',
    from: '0xfffa5813ed9a5db4880d7303db7d0cbe41bc771f',
    to: '0x83ec7b0506556a7749306d69681adbdbd08f0769',
    value: '3',
...
describe('Transactions Component', () => {
  ...
  test('item render', () => {
    ...
    expect(wrapper.find('tbody > tr:first-child td:last-child').text()).toBe(
      'Value: 1 Ether'
    );
    expect(wrapper.find('tbody > tr:last-child td:last-child').text()).toBe(
      'Value: 3 Ether'
    );
  });
});
